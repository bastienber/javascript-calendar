document.addEventListener('DOMContentLoaded', function() {
    ...
    function calendar(date) {
        ...
        let lastDayOfMonth = new Date(firstDayOfMonth.getFullYear(), firstDayOfMonth.getMonth() + 1, 1);
    ...
    function addingEvents() {
        ...
        saveBtn.addEventListener('click', function() {
            ...
            //the events are displayed at the save button
            checkEvent();
        });

        //the events are displayed at the page loading
        checkEvent();

    }

    //displaying events with the class eventHere
    function checkEvent() {
